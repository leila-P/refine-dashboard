      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" >
        ...
        >
          ...
          <FormControl>
           ...
           color="info"
           style={{ width: "100%", background: "transparent", fontSize: "15px", borderColor: 'rgba(0,0,0,0.23)', borderRadius: 6, padding:10, color:'#919191'}}
           {...register('description',{required:true})}
           />
          </FormControl>
          <Stack direction="row" gap={4}>
            <FormControl sx={{ flex:1}} >
              <FormHelperText sx={{ fontWight:500, margin: '10px 0', fontSize: 16, color:'#11142d'  }}>
          ...
          <FormControl>
            ...
            >
              ...
              <Typography fontSize={14} color="#808191" sx={{wordBrake: 'break-all'}}>{propertyImage?.name}</Typography>
            </Stack>
            <CustomButton 
            type="submit"
